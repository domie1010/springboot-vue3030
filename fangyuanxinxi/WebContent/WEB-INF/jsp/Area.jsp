	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="area/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${area['id'] }">
					<ul class="forminfo">
						<li><label>城区名称<b>*</b></label><input id="name"  placeholder="请输入城区名称" value="${area['name'] }"
							name="name" type="text" class="dfinput"
							style="width: 518px;" /></li>
						<li><label>所属城市<b>*</b></label><div class="vocation">
							<select name="city_id" class="select3">
								<c:forEach items="${cityList }" var="city">
									<c:if test="${area['city']['id'] eq city['id']}" var="s2">
