	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="field/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${field['id'] }">
					<ul class="forminfo">
						<li><label>片区名称<b>*</b></label><input id="name"  placeholder="请输入片区名称" value="${field['name'] }"
							name="name" type="text" class="dfinput"
							style="width: 518px;" /></li>
						<li><label>所属城区<b>*</b></label><div class="vocation">
							<select name="area_id" class="select3">
								<c:forEach items="${areaList }" var="area">
									<c:if test="${field['area']['id'] eq area['id']}" var="s2">
