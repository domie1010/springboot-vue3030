	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="houseBase/informationUpdate" method="POST" enctype="multipart/form-data"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${houseBase['id'] }">
					<ul class="forminfo">
						<li><label>楼盘名称<b>*</b></label><input id="name" 
							name="name" type="text" class="dfinput" placeholder="请填写楼盘名称" value="${houseBase['name'] }"
							style="width: 518px;" /></li>
						<li><label>楼盘地址<b>*</b></label><input id="address" 
							name="address" type="text" class="dfinput" placeholder="请填写楼盘地址" value="${houseBase['address'] }"
							style="width: 518px;" /></li>
						<li><label>详情<b>*</b></label><textarea name="remark" id="content7">${houseBase['remark'] }</textarea></li>
