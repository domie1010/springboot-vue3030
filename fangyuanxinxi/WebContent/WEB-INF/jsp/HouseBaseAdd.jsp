	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="houseBase/informationAdd" method="POST" enctype="multipart/form-data"
					onsubmit="return checkSubmit();">
					<ul class="forminfo">
						<li><label>楼盘名称<b>*</b></label><input id="name" 
							name="name" type="text" class="dfinput" placeholder="请填写楼盘名称"
							style="width: 518px;" /></li>
						<li><label>楼盘地址<b>*</b></label><input id="address" 
							name="address" type="text" class="dfinput" placeholder="请填写楼盘地址"
							style="width: 518px;" /></li>
