	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="look/informationAdd" method="POST"
					onsubmit="return checkSubmit();">
					<ul class="forminfo">
						<li><label>看房人<b>*</b></label><div class="vocation">
						...
						<li><label>中介人员<b>*</b></label><input id="name" 
							name="name" type="text" class="dfinput"
							style="width: 518px;" /></li>
						<li><label>房屋名称<b>*</b></label><div class="vocation">
							<select name="house_id" class="select3">
								<c:forEach items="${houseList }" var="house">
									<option value="${house['id'] }">${house['name'] }</option>
								</c:forEach>
							</select></div>
						</li>
						<li><label>看房时间<b>*</b></label><input id="look_time" 
							name="look_time" type="text" class="dfinput"
							style="width: 518px;" /></li>	
						<li><label>看房结果<b>*</b></label><input id="result" 
							name="result" type="text" class="dfinput"
							style="width: 518px;" /></li>	
