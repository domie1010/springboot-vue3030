	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="house/informationUpdate" method="POST" enctype="multipart/form-data"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${house['id']}">
					<ul class="forminfo">
						<li><label>房屋名称<b>*</b></label><input id="name" value="${house['name']}"
							name="name" type="text" class="dfinput" placeholder="请填写房屋名称"
							style="width: 518px;" /></li>
						<li><label>房屋地址<b>*</b></label><input id="address" value="${house['address']}"
							name="address" type="text" class="dfinput" placeholder="请填写房屋地址"
							style="width: 518px;" /></li>
						<li><label>房屋大小<b>*</b></label><input id="size" value="${house['size']}"
							name="size" type="text" class="dfinput" placeholder="请填写房屋大小"
							style="width: 518px;" /></li>
						<li><label>户主<b>*</b></label><input id="owner" value="${house['owner']}"
							name="owner" type="text" class="dfinput" placeholder="请填写户主"
							style="width: 518px;" /></li>
						<li><label>价格<b>*</b></label><input id="price" value="${house['price']}"
							...
							<select name="base_id" class="select3">
								<c:forEach items="${houseBaseList }" var="houseBase">
									<c:if test="${houseBase['id'] eq house['houseBase']['id']}" var="s1">
									<option value="${houseBase['id'] }" selected="selected">${houseBase['name'] }</option>
									</c:if>
									<c:if test="${!s1}" var="s1">
						...
						<li><label>详情<b>*</b></label><textarea name="remark" id="content7">${house['remark'] }</textarea></li>
