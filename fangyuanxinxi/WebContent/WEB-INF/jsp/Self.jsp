	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="self/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${self['id'] }">
					<ul class="forminfo">
						<li><label>星级名称<b>*</b></label><input id="name"  placeholder="请输入星级名称" value="${self['name'] }"
							name="name" type="text" class="dfinput"
							style="width: 518px;" /></li>
						<li><label>房源数量<b>*</b></label><input id="house_num"  placeholder="请输入房源数量" value="${self['house_num'] }"
							name="house_num" type="text" class="dfinput"
							style="width: 518px;" /></li>
						<li><label>展示数量<b>*</b></label><input id="show_num"  placeholder="请输入展示数量" value="${self['show_num'] }"
							name="show_num" type="text" class="dfinput"
							style="width: 518px;" /></li>
						<li><label>精品数量<b>*</b></label><input id="good_house_num"  placeholder="请输入精品数量" value="${self['good_house_num'] }"
							name="good_house_num" type="text" class="dfinput"
							style="width: 518px;" /></li>
...
var look_time = {
    ...
    function checkSubmit() { 
      ...
      var good_house_num = $("#good_house_num").val();
		if(!$.trim(name)){
			alert('请输入星级名称!');
			return false;
		}
