	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="self/informationAdd" method="POST"
					onsubmit="return checkSubmit();">
					<ul class="forminfo">
						<li><label>星级名称<b>*</b></label><input id="name"  placeholder="请输入星级名称"
							name="name" type="text" class="dfinput"
							style="width: 518px;" /></li>
						<li><label>房源数量<b>*</b></label><input id="house_num"  placeholder="请输入房源数量"
							name="house_num" type="text" class="dfinput"
							style="width: 518px;" /></li>
						<li><label>展示数量<b>*</b></label><input id="show_num"  placeholder="请输入展示数量"
							name="show_num" type="text" class="dfinput"
							style="width: 518px;" /></li>
						<li><label>精品数量<b>*</b></label><input id="good_house_num"  placeholder="请输入精品数量"
