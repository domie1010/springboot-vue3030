...
<table width="100%" height="27" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <td class="shopcarttitle">您有以下看房信息</td>
  </tr>
</table>
<br>
<br>
<table width="100%" border="0" cellpadding="3" cellspacing="0" class="shopcart">
		  <tr >
		    <td class="cap">&nbsp;</td> 
			<td class="cap">房屋名称</td>
			<td class="cap">经纪人</td>
			<td class="cap">预约时间</td>
			<td class="cap">看房结果</td>
		  </tr>
		  <c:forEach items="${pager.datas }" var="look" varStatus="vs">
                <tr >
	                <td>&nbsp; </td>
							<td><c:out value="${look['house']['name'] }"></c:out></td>
							<td><c:out value="${look['house']['userInfo']['userName'] }"></c:out></td>
							<td><c:out value="${look['createtime'] }"></c:out></td>
							<td>
							<c:if test="${look['result'] eq '' or look['result'] eq null}" var="t1">
								<c:out value="暂无"></c:out>
							</c:if>
							<c:if test="${!t1 }">
								<c:out value="${look['result'] }"></c:out>
							</c:if>
							</td>
                </tr>
 			 </c:forEach>
