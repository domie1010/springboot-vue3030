...
<ul class="bbslist">
	...
	<li>
	<a href="message/informationLoadOneFore?id=${messageI['id'] }">
	${messageI['message'] } &nbsp;&nbsp;留言经纪人:${messageI['house']['userInfo']['userName'] } &nbsp;&nbsp;留言状态:
								<c:if test="${messageI['flag'] eq 0}">
									<c:out value="未回复" />
								</c:if>
								<c:if test="${messageI['flag'] eq 1}">
									<c:out value="已回复" />
								</c:if>
	</a>
	</li>
