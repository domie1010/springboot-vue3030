...
<c:if test="${sessionScope['User'] ne null and sessionScope['User'] ne '' }">
	<a href="house/informationLoadForeBuy" target="_self" class="channelmenu_main" id="channelmenu_main_3" onMouseOver="showSubMenu('channelmenu_main','channelmenu_sub','3')">售房信息</a>
	<a href="house/informationLoadForeRent" target="_self" class="channelmenu_main" id="channelmenu_main_4" onMouseOver="showSubMenu('channelmenu_main','channelmenu_sub','4')">租房信息</a>
	<a href="house/informationLoadForeGood" target="_self" class="channelmenu_main" id="channelmenu_main_4" onMouseOver="showSubMenu('channelmenu_main','channelmenu_sub','2')">精品推荐</a>
	<a href="user/queryOneFore?id=${sessionScope['User']['id'] }" target="_self" class="channelmenu_main" id="channelmenu_main_4" onMouseOver="showSubMenu('channelmenu_main','channelmenu_sub','7')">我的信息</a>
	<a href="request/password" target="_self" class="channelmenu_main" id="channelmenu_main_4" onMouseOver="showSubMenu('channelmenu_main','channelmenu_sub','8')">修改密码</a>
	<a href="look/informationLoadFore" target="_self" class="channelmenu_main" id="channelmenu_main_6" onMouseOver="showSubMenu('channelmenu_main','channelmenu_sub','6')">看房预约</a>

	<a href="message/informationLoadFore" target="_self" class="channelmenu_main" id="channelmenu_main_5" onMouseOver="showSubMenu('channelmenu_main','channelmenu_sub','5')">我的留言</a>
</c:if></div>
...
<div id="shopcontent">
<form method="post" id="house" action="look/informationAddFore" onsubmit="return check();">
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <div class="piczone">
				...
				<td align="center">
				<div id="shopview">
					<img src="upload/upload/${house['url'] }" style="width: 174px;height: 241px;" border="0" id="shoploading" class="shoploading">
				</div>
				</td>
				</tr>
				</table>
          ...
          <td>
		  <div id="prodtitle">${house['name'] }<c:if test="${house['good'] eq 1}"><font color="red">(精品房源)</font></c:if> </div>
			<div id="prop">
				房屋大小：${house['size'] }<br />
				经纪人：${house['userInfo']['userName'] }<br />
				所在地址：${house['address'] }<br />
				户主：${house['owner'] }<br />
			</div>
			<div style="padding:5px;">
			租赁价格(每月)：<span class="price">￥${house['price'] }</span><br />
			</div>
			<div class="buttonzone"> 
				<input type="hidden" name="user_id" value="${sessionScope['User']['id'] }">
				<input type="hidden" name="house_id" value="${house['id'] }">
				<input type="submit" id="submit" value="我要预约">
				<a href="request/messageAddFore?house_id=${house['id'] }">留言</a>
			<!-- <a href="javascript:;" onclick="return bargain();"><img src="image/image/foreground/adddoctort.gif" alt="订购" width="102" height="27" border="0" class="addtodoctort"  id="addtodoctort" ></a>
	...
	<div id="switch_body" class="bodyzone_cap_now">房屋介绍</div>
...
<a href="request/login" target="_self">后台系统</a>|
