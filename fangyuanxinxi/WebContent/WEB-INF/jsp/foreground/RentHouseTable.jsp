...
<div class="shopquery">
		<div class="fang" style="width:120px;height:120px">
			...
			<a href="house/informationLoadOneForeRent?id=${house['id'] }" target="_self" ><img src="upload/upload/${house['url'] }" style="width:120px;height:120px" border="0" /></a>
			</div>
		</div>
		<div class="prop">
		价格：<span class="hb">￥</span><span class="price">${house['price'] }</span><br />
		</div>
		<a href="house/informationLoadOneForeRent?id=${house['id'] }" target="_self" class="prodtitle"   >${house['name'] }<c:if test="${house['good'] eq 1}"><font color="red">(精品房源)</font></c:if></a>
		<div class="memo" >
		${house['name'] }
		</div>
</div>
...
<div id="showpages" >
	  ...
	  <a href="house/informationLoadForeRent?pageNow=${pager.pageNow }">上一页</a>
	  </c:if>
	   <c:if test="${!pagele}">
	  <a href="house/informationLoadForeRent?pageNow=${pager.pageNow -1}">上一页</a>
	  </c:if>
	  </li>
	  <li class="pbutton">
	  <c:if test="${pager.pageNow ge pager.totalPages }" var="pagege">
	  <a href="house/informationLoadForeRent?pageNow=${pager.pageNow }">
	  下一页
	  </a>
	  </c:if>
	  <c:if test="${!pagege }">
