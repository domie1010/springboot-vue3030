...
<c:if test="${sessionScope['User'] ne null and sessionScope['User'] ne '' }">
	...
	<a href="house/informationLoadForeGood" target="_self" class="channelmenu_main" id="channelmenu_main_2" onMouseOver="showSubMenu('channelmenu_main','channelmenu_sub','2')">精品推荐</a>
	<a href="user/queryOneFore?id=${sessionScope['User']['id'] }" target="_self" class="channelmenu_main" id="channelmenu_main_7" onMouseOver="showSubMenu('channelmenu_main','channelmenu_sub','7')">我的信息</a>
	<a href="request/password" target="_self" class="channelmenu_main" id="channelmenu_main_8" onMouseOver="showSubMenu('channelmenu_main','channelmenu_sub','8')">修改密码</a>
